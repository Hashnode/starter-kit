...
export const getAutogeneratedPostOG = (post: PostType, publication: PublicationType) => {
    ...
    const ogUrl = `https://${hostname}/api/og/post`;
    const ogData: any = {};
  ...
  export const getAutogeneratedPublicationOG = (
  ...
  export default getAutogeneratedPostOG;