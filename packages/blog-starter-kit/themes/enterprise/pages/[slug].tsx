...
const Post = ({ publication, post, relatedPosts }: PostProps) => {
  ...
  // Kategori ve tür bilgilerini belirle
  const category = post.tags && post.tags.length > 0 ? post.tags[0].name : undefined;
  const type = post.tags && post.tags.length > 1 ? post.tags[1].name : undefined;
