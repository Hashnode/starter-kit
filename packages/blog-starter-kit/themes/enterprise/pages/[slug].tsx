  ...
  return (
    <>
      <Head>
        ...
        />
        <meta property="og:image" content={post.ogMetaData.image || getAutogeneratedPostOG(post, publication)} />
        <meta property="twitter:image" content={post.ogMetaData.image || getAutogeneratedPostOG(post, publication)} />
        <script
