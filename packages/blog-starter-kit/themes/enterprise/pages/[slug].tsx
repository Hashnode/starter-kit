...
const PostComments = dynamic(() => import("../components/post-comments"));
  ...
  return (
    <>
      <Head>
        ...
        <meta property="twitter:image" content={post.ogMetaData?.image || post.coverImage?.url || getAutogeneratedPostOG(post, publication)} />
        <script
