	...
	return (
		<>
			...
			<title>{post.seo?.title || post.title} | Temizmama Blog</title>
				...
				<meta property="og:image" content={post.ogMetaData?.image || post.coverImage?.url || getAutogeneratedPostOG(post, publication)} />
				<meta property="og:image:alt" content={`${post.seo?.title || post.title} görseli`} />
				<meta property="og:description" content={post.seo?.description || post.subtitle || post.brief} />

				{/* Twitter Card Meta Tags */}
				<meta name="twitter:card" content="summary_large_image" />
				<meta name="twitter:site" content="@temizmamablog" /> {/* Eğer Twitter hesabınız varsa */}
				<meta name="twitter:title" content={`${post.seo?.title || post.title} | Temizmama Blog`} />
				<meta name="twitter:description" content={post.seo?.description || post.subtitle || post.brief} />
				<meta name="twitter:image" content={post.ogMetaData?.image || post.coverImage?.url || getAutogeneratedPostOG(post, publication)} />
				<meta name="twitter:image:alt" content={`${post.seo?.title || post.title} görseli`} />
				...
				{`
					...
					"image": "${post.ogMetaData?.image || post.coverImage?.url || getAutogeneratedPostOG(post, publication)}",
					"author": {
						"@type": "Person",
