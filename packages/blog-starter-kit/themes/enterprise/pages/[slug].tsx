...
import { hashnodeRequest, isTransientNetworkError } from '../lib/api/hashnode-request';
...
export const getStaticProps: GetStaticProps<Props, Params> = async ({ params }) => {
  ...
  try {
    // Post için kontrol
    const postData = await hashnodeRequest(endpoint, SinglePostByPublicationDocument, { host, slug });
    ...
    const pageData = await hashnodeRequest(endpoint, PageByPublicationDocument, { host, slug });
    ...
    const seriesData = await hashnodeRequest(endpoint, SeriesPostsByPublicationDocument, {
      host,
      seriesSlug: slug,
      first: 20,
    });
