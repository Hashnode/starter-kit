            ...
            <div className="mt-6">
              ...
              >
                {isButtonDisabled 
                  ...
                  : isFormSubmitted
                    ? 'Gönderildi!'
                    : <span className="flex items-center justify-center"><svg xmlns="https://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="w-5 h-5 mr-2"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg>Gönder</span>
                }
              </button>
            </div>
          </form>
