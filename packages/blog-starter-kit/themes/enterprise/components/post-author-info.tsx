			...
			<div className="mb-4 flex w-full flex-1 flex-row md:mb-0 ">
				...
				>
					<div className="flex flex-row items-center md:mb-1">
						<h1 className="font-sans text-base font-semibold text-slate-800 dark:text-slate-100">
					...
					{author.bio?.html && (
						<div className="hidden pr-2 md:block">
							<div
								className="prose dark:prose-dark text-sm text-slate-600 dark:text-slate-300"
