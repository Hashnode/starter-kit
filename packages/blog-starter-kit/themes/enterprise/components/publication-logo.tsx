			...
			>
				{PUBLICATION_LOGO ? (
					<>
						...
						/>
						{/*<span className="text-xl font-semibold font-mono text-stone-400	 md:text-3xl">AUTONETOPS</span>*/}
					</>
				) : (
					<span
						className={`block text-2xl font-semibold ${
							isSidebar ? 'text-black dark:text-stone-400	' : 'text-stone-400	 md:text-4xl'
						}`}
					>
						{publication.title}
					</span>
