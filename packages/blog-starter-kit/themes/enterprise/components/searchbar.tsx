			  ...
			  {isSearching && searchResults.length === 0 ? (
				...
				<>
				  ...
				  {hasNextPage && (
					<button
					  onClick={loadMore}
					  className="mt-4 px-4 py-2 bouncing-blob--purple text-white rounded hover:bg-orng-600 focus:outline-none focus:ring-2 focus:bg-orng-600 focus:ring-opacity-50 w-full"
