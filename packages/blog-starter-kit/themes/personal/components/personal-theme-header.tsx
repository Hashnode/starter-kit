...
export const PersonalHeader = () => {
	...
	return (
		<header className="grid grid-cols-2 items-center gap-5 bg-indigo-600 ">
			<div className="col-span-full md:col-span-1">
				<h1>
					<Link
						className="flex flex-row items-center gap-2 font-sans text-lg font-bold leading-tight tracking-tight text-black dark:text-white"
						href="/"
