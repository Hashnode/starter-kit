			...
			<Layout>
				<Head>
					...
					<meta
						name="description"
						content={
							publication.descriptionSEO || publication.title || `megabyte's Blog`
						}
					/>
					<meta property="twitter:card" content="summary_large_image" />
					<meta property="twitter:title" content={publication.displayTitle || publication.title || 'Hashnode Blog Starter Kit'} />
					<meta property="twitter:description" content={publication.descriptionSEO || publication.title || `megabyte's Blog`} />
					<meta
						property="og:image"
