...
export default function Post({ publication, draft }: Props) {
	...
	const title = `${draft.title} | Next.js Blog Example with Hashnode`;
	...
	const postContent = Autolinker.link(draft.content.markdown, {
		twitter: true,
		truncate: 45,
