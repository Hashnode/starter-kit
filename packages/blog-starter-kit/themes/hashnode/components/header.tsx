...
export const Header = (props: Props) => {
	...
	return (
		<header
			className="blog-header relative z-50 w-full border-b border-black/10 bg-krida-primary dark:border-white/10 dark:bg-krida-primary"
		>
			<div className="container mx-auto px-2 md:px-4 2xl:px-10">
				<div className="relative z-40 flex flex-row items-center justify-between pb-2 pt-8 md:mb-4">
					...
					>
						...
						<Button as="a" href="https://krida-play.com" type="primary" label="Start Game"/>
					</div>
				</div>
