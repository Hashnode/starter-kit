...
function OtherPostsOfAccount(props: Props) {
  ...
  console.log(post, morePosts, "HEY")
  const morePostsRendered = morePosts.map((postNode: any) => {
    ...
    return (
      <div
        className={twJoin(
          'mb-5 px-2 border-slate-800 lg:mb-0',
          morePosts.length === 1
      ...
      >        <BlogPostPreview post={post} featured={true} />
      </div>
      // <div
      //   className={twJoin(
      //     'mb-5 px-2 border-slate-800 lg:mb-0',
      ...
      //   key={post.id.toString()}
      // >
      //   <div className="blog-similar-article-wrapper h-full rounded-lg border p-4 border-slate-800">
      //     {post.author && (
      ...
      //             className="blog-similar-author-name font-bold text-white"
      //           >
      //             {post.author.name}
      //           </a>
      //         </div>
      ...
      //       <a
      //         href={postURL}
      //         className="blog-similar-article-cover post-cover mb-3 block rounded border bg-cover bg-centerborder-slate-800"
      //       >
      //         <CustomImage
      //           alt={post.title}
      //           layout="responsive"
      ...
      //       <h1 className="mb-2 font-heading text-2xl font-bold leading-tight tracking-tight text-slate-900 text-white">
      //         <a href={postURL}>
