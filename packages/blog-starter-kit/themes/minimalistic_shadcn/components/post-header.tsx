...
export const PostHeader = ({
	...
	return (
		<>
			...
			<div className="font-ranadeRegular z-50 flex w-full flex-col items-center justify-center gap-5 space-x-5 text-slate-700 dark:text-neutral-300 md:flex-row md:gap-0">
				<HoverCard>
					<HoverCardTrigger>
					...
					<HoverCardContent className="flex flex-col md:w-[750px]">
						<div className="mb-3 flex w-full flex-wrap items-center space-x-8 text-center">
							{badges &&
								badges.map((badge) => (
									<>
