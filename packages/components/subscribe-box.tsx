    ...
    <>
      <div className="relative w-full p-2 bg-white rounded-full dark:bg-neutral-950">
        <input
          ...
          className="w-full p-3 text-base text-white rounded-full outline-none dark:text-neutral-50 dark:bg-neutral-950 top-3 left-3 focus:outline-primary-600 dark:focus:outline-primary-500"
        />
